...
log_path = os.path.join('Training', 'Logs', 'dqn_chess_tensorboard')
os.makedirs(log_path, exist_ok=True)  # Crée le répertoire s'il n'existe pas
...
dqn_path = os.path.join('Training', 'Saved Models', 'dqn_chess')
os.makedirs(os.path.dirname(dqn_path), exist_ok=True)  # Crée le répertoire s'il n'existe pas
model.save(dqn_path)
